...
This guide uses the Gist 960"

https://huggingface.co/datasets/open-vdb/gist-960-euclidean


* Create Dataverse and Dataset (Column Storage)
...
PRIMARY KEY k AUTOGENERATED WITH {
...
FROM movie m
LET qvec = [ /* 980-dimensional query vector */ ]
SELECT m.k
