...
public class SqlppExecutionVectorTest {
    ...
    @Parameters(name = "SqlppExecutionVector {index}: {0}")
    public static Collection<Object[]> tests() throws Exception {
        return LangExecutionUtil.tests("only_sqlpp.xml", "testsuite_vector.xml");
    }

    protected TestCaseContext tcCtx;

    public SqlppExecutionVectorTest(TestCaseContext tcCtx) {
        this.tcCtx = tcCtx;
    }
