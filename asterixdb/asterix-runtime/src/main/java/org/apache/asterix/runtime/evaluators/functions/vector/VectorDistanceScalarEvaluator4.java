...
import org.apache.asterix.runtime.utils.VectorDistanceCalculation3;
...
public class VectorDistanceScalarEvaluator4 implements IScalarEvaluator {
    ...
    private static final Map<Integer, DistanceFunction> DISTANCE_MAP =
            Map.of(MANHATTAN_FORMAT.hash(), VectorDistanceCalculation3::manhattan, EUCLIDEAN_DISTANCE.hash(),
                    VectorDistanceCalculation3::euclidean, COSINE_FORMAT.hash(), VectorDistanceCalculation3::cosine,
                    DOT_PRODUCT_FORMAT.hash(), VectorDistanceCalculation3::dot);
    ...
    public VectorDistanceScalarEvaluator4(IEvaluatorContext context, final IScalarEvaluatorFactory[] evaluatorFactories,
