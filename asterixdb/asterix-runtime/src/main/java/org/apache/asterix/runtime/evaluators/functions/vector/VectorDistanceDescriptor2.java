...
public class VectorDistanceDescriptor2 extends AbstractScalarFunctionDynamicDescriptor {
    ...
    public final static IFunctionDescriptorFactory FACTORY = DescriptorFactoryUtil
            .createFactory(VectorDistanceDescriptor2::new, FunctionTypeInferers.SET_ARGUMENTS_TYPE);
    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(final IEvaluatorContext ctx) throws HyracksDataException {
                return new VectorDistanceScalarEvaluator2(ctx, args, getIdentifier(), sourceLoc);
            }
        };
