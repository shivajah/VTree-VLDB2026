...
public class VectorDistanceScalarEvaluator7 implements IScalarEvaluator {
    ...
    public VectorDistanceScalarEvaluator7(IEvaluatorContext context, final IScalarEvaluatorFactory[] evaluatorFactories,
        ...
        primitiveArrayConstant[0] = new double[512];
        primitiveArrayConstant[1] = new double[512];
        for (int i = 0; i < evaluators.length; ++i) {
            ...
            if (evaluatorFactories[i] instanceof ConstantEvalFactory) {
                ...
                if (i == 2) {
                    ...
                    try {
                        primitiveArrayConstant[i] = createPrimitveList(listAccessorConstant[i], primitiveArrayConstant[i]);
                    } catch (IOException e) {
    ...
    public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
        ...
        double distanceCal;
        try {
            double[] primitiveArray1 = isConstant[0] ? primitiveArrayConstant[0] : createPrimitveList(listAccessor1,primitiveArrayConstant[0]);
            double[] primitiveArray2 = isConstant[1] ? primitiveArrayConstant[1] : createPrimitveList(listAccessor2,primitiveArrayConstant[1]);
