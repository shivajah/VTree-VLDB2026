    ...
    private class VCTreeStaticStructureBulkLoaderNodePushable extends AbstractUnaryInputUnaryOutputOperatorNodePushable {
        ...
        private void processRealTuple(ITupleReference tuple) throws HyracksDataException {
                ...
                try {
                    ...
                    Map<Integer, Integer> levelClusters = clusterDistribution.computeIfAbsent(levelKey, k -> new HashMap<>());
        ...
        private void processRealCentroid(int level, int clusterId, int centroidId, IPointable embeddingVal, ITupleReference tuple) throws HyracksDataException {
            try {
                ...
                if (embeddingLength > 1) {
                    ...
                    System.err.println("Processing real centroid: Level=" + level + 
                                      ", Cluster=" + clusterId + 
                                      ", Centroid=" + centroidId + 
                                      ", EmbeddingSize=" + (embeddingLength - 1) + " bytes");
