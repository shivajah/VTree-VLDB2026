...
public class VectorDistanceScalarEvaluator2 implements IScalarEvaluator {
    ...
    public VectorDistanceScalarEvaluator2(IEvaluatorContext context, final IScalarEvaluatorFactory[] evaluatorFactories,
