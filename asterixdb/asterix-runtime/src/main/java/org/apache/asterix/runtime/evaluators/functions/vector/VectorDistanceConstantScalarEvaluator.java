...
public class VectorDistanceConstantScalarEvaluator implements IScalarEvaluator {
    ...
    private static final Map<Integer, DistanceFunction> DISTANCE_MAP = Map.of(MANHATTAN_FORMAT.hash(),
            ...
            VectorDistanceArrCalculation::euclidean_squared, COSINE_FORMAT.hash(), VectorDistanceArrCalculation::cosineDistance,
