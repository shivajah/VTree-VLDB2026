...
public class VCTreeSorter {
     ...
     */
    private List<VCTreeStaticStructureCreatorOperatorDescriptor.DummyTuple> readCentroidData(FileReference inputFile)
     ...
     */
    private List<FileReference> createSortedRuns(int centroidId,
            List<VCTreeStaticStructureCreatorOperatorDescriptor.DummyTuple> data) throws HyracksDataException {
    ...
    private FileReference mergeRuns(int centroidId, List<FileReference> runs) throws HyracksDataException {
        ...
        FileReference sortedFile = ctx.getJobletContext()
                .createManagedWorkspaceFile("VCTreeCentroid_" + centroidId + "_sorted_" + System.currentTimeMillis());
