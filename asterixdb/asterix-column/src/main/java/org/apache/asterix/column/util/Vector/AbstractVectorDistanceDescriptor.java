package org.apache.asterix.column.util.Vector;
...
public abstract class AbstractVectorDistanceDescriptor extends AbstractScalarFunctionDynamicDescriptor {

    private static final long serialVersionUID = 1L;

    abstract protected double evaluateVector(double[] vector0, double[] vector1) throws HyracksDataException;
    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(final IEvaluatorContext ctx) throws HyracksDataException {
                return new AbstractVectorDistanceEvaluator(args, ctx);
            }
        };
    }

    private class AbstractVectorDistanceEvaluator implements IScalarEvaluator {
        ...
        public AbstractVectorDistanceEvaluator(IScalarEvaluatorFactory[] args, IEvaluatorContext ctx)
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            try {
                ...
                Object finalResult = evaluateVector(new double[1], new double[2]);
