 ...
 *
 * This class passes information from the optimizer (Algebricks layer) to the physical
 * runtime (Hyracks layer) for vector index ANN search.
 *
 * Parameters passed:
 * - queryVarList: Variables containing the query vector, k value, and distance metric
 *   [0] = query vector variable (e.g., from constant [1.0, 2.0, ...])
 *   [1] = k value variable (e.g., from LIMIT 10)
 *   [2] = distance metric variable (e.g., from constant "Euclidean")
 */
public class VectorJobGenParams extends AccessMethodJobGenParams {

    // Variables for ANN search: [query_vector, k_value]
    ...
    public void readFromFuncArgs(List<Mutable<ILogicalExpression>> funcArgs) throws AlgebricksException {
        ...
        queryVarList = new ArrayList<LogicalVariable>();
