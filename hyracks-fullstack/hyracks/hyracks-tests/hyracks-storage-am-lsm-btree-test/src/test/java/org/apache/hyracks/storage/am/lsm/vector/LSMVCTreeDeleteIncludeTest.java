...
/**
 * LSMVCTree delete test with integer include fields.
...
public class LSMVCTreeDeleteIncludeTest {
    ...
    public void threeDimensionThreeLevelsDeleteWithIncludes() throws Exception {
        // Create structure with integer include field
        ...
        // Create test context with numIncludeFields=1
        ...
        try {
            ...
            // 3. Bulk load data records with include fields
            ...
            // 4. Delete specific records from c10
            // c10 centroid: [20.0, 30.0, 20.0]
            // Delete records at first ring (distance=0.2): pk_c_10_0 through pk_c_10_4
