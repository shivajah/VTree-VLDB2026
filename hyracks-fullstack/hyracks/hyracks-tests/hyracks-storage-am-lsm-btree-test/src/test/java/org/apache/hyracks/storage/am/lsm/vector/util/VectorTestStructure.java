...
public class VectorTestStructure {
    ...
    /**
     * Build centroid tuples for static structure building.
    ...
    public List<ITupleReference> buildCentroidTuples() throws HyracksDataException {
        ...
        for (int i = 0; i < allCentroidIds.size(); i++) {
     ...
     */
    static ITupleReference createInsertTuple(double[] vector, String primaryKey) throws HyracksDataException {
