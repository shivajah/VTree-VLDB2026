...
/**
 * LSMVCTree insert test with integer include fields.
...
public class LSMVCTreeInsertIncludeTest {
    ...
    public void threeDimensionThreeLevelsWithIncludes() throws Exception {
        ...
        // Pre-count include value distribution for c10 bulk load records
        ...
        try {
            ...
            // 4. Generate and insert additional records with include fields
            ...
            // 5. Search near c10 and verify include field values
