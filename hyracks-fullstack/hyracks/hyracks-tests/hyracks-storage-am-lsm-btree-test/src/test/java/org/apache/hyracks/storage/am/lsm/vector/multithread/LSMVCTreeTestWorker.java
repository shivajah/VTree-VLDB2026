...
/**
 * Worker thread that inserts pre-generated vector tuples into an LSMVCTree index.
 ...
 */
public class LSMVCTreeTestWorker implements Runnable {

    private final IIndexAccessor accessor;
    private final List<ITupleReference> tuples;
    private volatile Exception exception;

    public LSMVCTreeTestWorker(IIndexAccessor accessor, List<ITupleReference> tuples) {
