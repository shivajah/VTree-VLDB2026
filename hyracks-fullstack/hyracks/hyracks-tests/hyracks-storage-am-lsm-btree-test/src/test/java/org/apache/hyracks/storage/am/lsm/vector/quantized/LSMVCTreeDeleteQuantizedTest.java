...
public class LSMVCTreeDeleteQuantizedTest extends QuantizedSearchTestDriver {
     ...
     * (LSMVCTreeBlockedCursor) handles this via the hold-and-check pattern.
     */
    @Override
    protected void runTest(ISerializerDeserializer[] centroidSerdes, ISerializerDeserializer[] dataRecordSerdes,
        ...
        LOGGER.info("LSMVCTree Delete Quantized Test: {} levels, {} centroids, {} leaf clusters, {}D vectors",
