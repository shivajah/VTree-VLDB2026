 ...
 * @author yingyib
 */
public class AccumulateClusterOperatorDescriptor extends AbstractSorterOperatorDescriptor {
     ...
     */
    public AccumulateClusterOperatorDescriptor(IOperatorDescriptorRegistry spec, int framesLimit, int[] sortFields,
