...
/**
 * Standard factory for creating {@link VCTreeDataTupleCreator} instances.
 *
 ...
 */
public class VCTreeDataTupleCreatorFactory implements IVCTreeDataTupleCreatorFactory {

    private static final long serialVersionUID = 1L;

    private final int numIncludeFields;

    public VCTreeDataTupleCreatorFactory(int numIncludeFields) {
        this.numIncludeFields = numIncludeFields;
    }

    @Override
    public IVCTreeDataTupleCreator createDataTupleCreator() {
        return new VCTreeDataTupleCreator(numIncludeFields);
    }
}
