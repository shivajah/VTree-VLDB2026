...
/**
 * Factory for creating vector clustering leaf frames.
 */
public class VectorClusteringLeafFrameFactory implements ITreeIndexFrameFactory {

    private static final long serialVersionUID = 1L;
    private final ITreeIndexTupleWriter tupleWriter;
    private final int centroidDimensions;

    public VectorClusteringLeafFrameFactory(ITreeIndexTupleWriter tupleWriter, int centroidDimensions) {
